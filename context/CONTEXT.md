...
- **Routines actives (depuis 2026-07-05) :** Morning brief (7h Haïti, quotidien, push), Santé hebdo (lundi 8h, push+email), Sentinelle (17h, quotidien, silencieuse si RAS, push+email). Lecture seule ; les actions d'argent restent à Thrasher. Détail : `context/ROADMAP-AUTONOMIE.md`.
