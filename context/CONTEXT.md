...
- **Audit « chemin critique vers le pilote » (COURT TERME, PRIORITAIRE — décision Thrasher 2026-07-12).** Avant toute acquisition de vendeurs, remplacer le critère infini « tout est correct » par un critère FINI et mesurable : **une transaction réelle de bout en bout réussie** (commande → escrow → paiement → livraison → libération des fonds → avis). Livrable = checklist rouge/jaune/vert de chaque rail (escrow RPC, paiement MonCash, machine à états des commandes, litiges, notifications role-aware, vérif vendeur), auditée sur le vrai code + la vraie base Supabase. Premier test = **pilote fermé, 2-3 vrais vendeurs contrôlés**, PAS de démo, PAS d'acquisition de masse. Cadrage Thrasher : « pas de démo, préparer l'infra pour de vrais résultats ; en Haïti les gens veulent des résultats pas le futur ; mieux vaut prendre le temps et apporter de meilleurs résultats. »
