...
> Commande pour démarrer une nouvelle session avec le contexte complet d'Alita.
...
```
Bonjour [Prénom], Alita a bien chargé ton contexte. Voici où on en est :
...
Alita est prête à t'aider. Que veux-tu faire aujourd'hui ?
```
